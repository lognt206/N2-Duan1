...
<div id="sidebar">
    ...
    <a href="?act=partner" class="bg-secondary"><i class="fa-solid fa-handshake"></i> Quản lý Đối tác</a>
...
<div id="content">
    ...
    <h3 class="mb-3"><i class="fa-solid fa-handshake"></i> Quản lý Đối tác</h3>

    <div class="d-flex justify-content-between mb-3">
        <a href="#" class="btn btn-primary"><i class="fa-solid fa-plus"></i> Thêm Đối tác</a>
        ...
        <table class="table table-bordered align-middle text-center">
            ...
            <tbody>
                <?php if (!empty($partners)) : ?>
                    ...
                    <?php endforeach; ?>
                <?php else : ?>
                    <tr><td colspan="7" class="text-center text-muted">Không có dữ liệu đối tác.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
