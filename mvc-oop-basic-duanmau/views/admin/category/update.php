...
<div id="content">
    ...
    <h3 class="mb-3"><i class="fa-solid fa-pen-to-square"></i> Cập nhật Category</h3>

    <div class="form-container">

        <form action="?act=category/update" method="POST"enctype="multipart/form-data">
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-success">
                    <i class="fa-solid fa-floppy-disk"></i> Cập nhật Category
                </button>
            </div>
