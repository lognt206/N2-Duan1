...
<form action="?act=create_customer" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="birth_year" name="birth_year" min="1900" max="2025">
            </div>
            <div class="mb-3">
                <label for="id_number" class="form-label">CMND/CCCD</label>
                <input type="text" class="form-control" id="id_number" name="id_number" placeholder="001306054432">
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="contact" name="contact" placeholder="nguyenvana@gmail.com">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="special_request" name="special_request" rows="3" placeholder="dị ứng hải sản"></textarea>
            </div>
        </div>
    </div>
