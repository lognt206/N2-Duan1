...
<body>
    ...
    <div id="sidebar">
        ...
        <a href="?act=customer" class="bg-secondary"><i class="fa-solid fa-users"></i> Quản lý Khách hàng</a>
                    ...
                    <?php if (!empty($customers)) : ?>
                        <?php foreach ($customers as $c) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="?act=customer_update&id=<?= $c->customer_id ?>" class="btn btn-sm btn-warning"><i class="fa-solid fa-pen"></i></a>
                                    <a href="?act=customer_delete&id=<?= $c->customer_id ?>" onclick="return confirm('Xóa khách hàng này?')" class="btn btn-sm btn-danger"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else : ?>
