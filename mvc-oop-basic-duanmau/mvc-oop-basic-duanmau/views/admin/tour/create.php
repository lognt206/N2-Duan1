...
<form action="index.php?act=store" method="POST" enctype="multipart/form-data">
        ...
        <div class="col 1">
            <h5 class="mb-3">Thông tin cơ bản</h5>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="tour_name" name="tour_name" placeholder="Tour Hà Nội - Hạ Long">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="description" class="form-label">Số ngày đêm</label>
                    <input type="text" class="form-control" id="description" name="description" placeholder="Du lịch 3N2Đ">
                </div>
                <div class="mb-3">
                    <label for="price" class="form-label">Giá (VNĐ)</label>
                    <input type="text" class="form-control" id="price" name="price" placeholder="40.000.000">
                </div>
        </div>
        ...
        <div class="col 1">
            <h5 class="mb-3">Thông tin khác</h5>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="policy" name="policy" placeholder="Hủy trước 7 ngày được hoàn tiền">
                </div>
                <div class="mb-3">
                    <label for="supplier" class="form-label">Nhà cung cấp</label>
                    <input type="text" class="form-control" id="supplier" name="supplier" placeholder="Công ty A">
                </div>
                <div class="mb-3">
    ...
    <div class="text-end mb-5">
        ...
        <button type="button" class="btn btn-secondary"><i class="fa-solid fa-xmark"></i> Hủy</button>
    </div>
</form>
